...
export default function ModelSelector() {
  ...
  return (
    <div className="space-y-3">
      <div>
        <label className="block text-xs font-semibold text-slate-300 mb-2">Source météo</label>
      ...
      <div>
        <label className="block text-xs font-semibold text-slate-300 mb-2">Modèle de prévision</label>
